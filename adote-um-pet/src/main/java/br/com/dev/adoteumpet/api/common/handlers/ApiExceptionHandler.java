package br.com.dev.adoteumpet.api.common.handlers;
...
import br.com.dev.adoteumpet.api.common.dtos.ErrorResponse;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private Map<String, List<String>> convertFieldErrors(List<FieldError> fieldErrors) {
        ...
        fieldErrors.stream().forEach(fieldError -> {
            Object field = snakeCaseStrategy.translate(fieldError.getField());
